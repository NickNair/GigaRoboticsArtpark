...
class Plume(object):
    ...
    def get_point_cloud_as_msg(self):
        ...
        pc.header.frame_id = 'nozzle_gripper'
        if self._pnts is None:
            return None
    ...
    def get_markers(self):
        ...
        source_marker.header.frame_id = 'nozzle_gripper'
        ...
        limits_marker.header.frame_id = 'nozzle_gripper'
        ...
        cur_vel_marker.header.frame_id = 'nozzle_gripper'
